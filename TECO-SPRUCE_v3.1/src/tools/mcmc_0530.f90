module mcmc
    ...
    integer, parameter :: istep_1 = 3001,  istep_2 = 6001, istep_3 = 9001 ! all, tree, shrub
    integer, parameter :: istep_4 = 12001, istep_5 = 15001, istep_6 = 5501 ! sphag, soil, annual ch4+Rh
    ...
    subroutine run_mcmc(st)
        ...
        ! 2. do cylces
        nDAsimu = istep_5-1 !mcset%nDAsimu
        do iDAsimu = 1, nDAsimu !mcset%nDAsimu
            ...
            if(iDAsimu < istep_1)then
                ! site-based
                DAparVal(1:27) = temp_new_parval(1:27)
                DAparVal(44)   = temp_new_parval(44)
                DAparVal(52)   = temp_new_parval(52) 
            elseif(iDAsimu < istep_2) then
                ! shrub
                DAparVal(141:158) = temp_new_parval(141:158)
                DAparVal(160:165) = temp_new_parval(160:165)
                DAparVal(174)     = temp_new_parval(174)
                DAparVal(214:216) = temp_new_parval(214:216)
            elseif(iDAsimu < istep_3) then
                ! sphagnum
                DAparVal(222:239) = temp_new_parval(222:239)
                DAparVal(241:246) = temp_new_parval(241:246)
                DAparVal(255)     = temp_new_parval(255)
                DAparVal(295:297) = temp_new_parval(295:297)
            ...
            elseif(iDAsimu<istep_4) then
                 ! tree
                DAparVal(60:77) = temp_new_parval(60:77)
                DAparVal(79:84) = temp_new_parval(79:84)
                DAparVal(93)    = temp_new_parval(93)
                DAparVal(133:135) = temp_new_parval(133:135)
            elseif(iDAsimu < istep_5)then
                ! site-based
                DAparVal(1:27) = temp_new_parval(1:27)
                DAparVal(44)   = temp_new_parval(44)
            ...
            !     DAparVal(17:27) = temp_new_parval(17:27)
            !     DAparVal(28:30) = temp_new_parval(28:30) ! Q10rh
            !     DAparVal(36:38) = temp_new_parval(36:38) ! Q10pro
            !     DAparVal(44:46) = temp_new_parval(44:46) ! Tpro_me
            !     DAparVal(52:54) = temp_new_parval(52:54) ! Tpro_rh
            !     ! ! tree parameters
            !     ! DAparVal(60:65) = temp_new_parval(60:65) ! LAImax, SapS, SLAx, GLmax, GRmax, Gsmax
            !     ! DAparVal(67:69) = temp_new_parval(67:69) ! Tau_Leaf, Tau_Stem, Tau_Root
            !     ! DAparVal(71:74) = temp_new_parval(71:74) ! Vcmax0, Tau_Leaf, Q10, Rl0
            !     ! DAparVal(76:77) = temp_new_parval(76:77) ! JV, fn2r
            !     ! DAparVal(79:83) = temp_new_parval(79:83) ! 
            !     ! DAparVal(85:87) = temp_new_parval(85:87) ! Entrpy
            !     ! DAparVal(93:95) = temp_new_parval(93:95) ! s_vea
            !     ! DAparVal(109:111) = temp_new_parval(109:111) ! Vcmax0
            !     ! DAparVal(117:119) = temp_new_parval(117:119) ! Q10
            !     ! DAparVal(125:127) = temp_new_parval(125:127) ! f_rg
            !     ! DAparVal(133:135) = temp_new_parval(133:135) ! fn2r
            !     ! ! shrub parameters
            !     ! DAparVal(141:146) = temp_new_parval(141:146)
            !     ! DAparVal(148:150) = temp_new_parval(148:150)
            !     ! DAparVal(152:155) = temp_new_parval(152:155)
            !     ! DAparVal(157:158) = temp_new_parval(157:158) 
            !     ! DAparVal(160:164) = temp_new_parval(160:164)
            !     ! DAparVal(166:168) = temp_new_parval(166:168)
            !     ! DAparVal(174:176) = temp_new_parval(174:176)
            !     ! DAparVal(190:192) = temp_new_parval(190:192)
            !     ! DAparVal(198:200) = temp_new_parval(198:200)
            !     ! DAparVal(206:208) = temp_new_parval(206:208)
            !     ! DAparVal(214:216) = temp_new_parval(214:216)
            !     ! ! sphagnum parameters
            !     ! DAparVal(222:227) = temp_new_parval(222:227)
            !     ! DAparVal(229:231) = temp_new_parval(229:231)
            !     ! DAparVal(233:236) = temp_new_parval(233:236)
            !     ! DAparVal(238:239) = temp_new_parval(238:239)
            !     ! DAparVal(241:245) = temp_new_parval(241:245)
            !     ! DAparVal(247:249) = temp_new_parval(247:249)
            !     ! DAparVal(255:257) = temp_new_parval(255:257)
            !     ! DAparVal(271:273) = temp_new_parval(271:273)
            !     ! DAparVal(279:281) = temp_new_parval(279:281)
            !     ! DAparVal(287:289) = temp_new_parval(287:289)
            !     ! DAparVal(295:297) = temp_new_parval(295:297)
            ! elseif(iDAsimu<istep_2)then
            !     ! shrub parameters
            !     DAparVal(141:146) = temp_new_parval(141:146)
            ...
            ! enddo
            if(iDAsimu == 1)     search_scale = 0.2! mcset%search_scale
            ...
            if(iDAsimu == istep_1) search_scale = 0.2! mcset%search_scale
            if(iDAsimu == istep_2) search_scale = 0.2! mcset%search_scale
            if(iDAsimu == istep_3) search_scale = 0.2! mcset%search_scale
            if(iDAsimu == istep_4) search_scale = 0.2! mcset%search_scale

module mcmc
    ...
    integer, dimension(10) :: nsteps
    integer, parameter :: istep_1 = 1001,  istep_2 = 10001, istep_3 = 15001 ! all, tree, shrub
    integer, parameter :: istep_4 = 20001, istep_5 = 25001, istep_6 = 30001 ! sphag, soil, annual ch4+Rh
    integer, parameter :: istep_7 = 35001, istep_8 = 40001, istep_9 = 45001 ! annual Tree, Shrub, Sphag
    integer, parameter :: istep_10 = 50001 ! all annual parameters

    ! integer, parameter :: istep_1 = 51,  istep_2 = 101, istep_3 = 151 ! all, tree, shrub
    ! integer, parameter :: istep_4 = 201, istep_5 = 251, istep_6 = 301 ! sphag, soil, annual ch4+Rh
    ! integer, parameter :: istep_7 = 351, istep_8 = 401, istep_9 = 451 ! annual Tree, Shrub, Sphag
    ! integer, parameter :: istep_10 = 501 ! all annual parameters
    ...
    subroutine run_mcmc(st)
        ...
        do iDAsimu = 1, nDAsimu !mcset%nDAsimu
            ...
            !     ! shrub 
            !     obsWt = [0, 100, 100, 100, 100, 100, 10, 10, & 
            !              10,  10, 10, 10, 10, 10, &
            !              10, 100, 100, 100, 10, 100, 10, 10]
            !     DAparVal(151:156) = temp_new_parval(151:156)
            !     DAparVal(158:160) = temp_new_parval(158:160)
            !     DAparVal(162:165) = temp_new_parval(162:165)
            !     DAparVal(167:168) = temp_new_parval(167:168)
            !     DAparVal(170:174) = temp_new_parval(170:174)
            !     DAparVal(176:240) = temp_new_parval(176:240)
            ! elseif(iDAsimu < istep_2) then
            !     ! shrub npp
            !     obsWt = [0, 1000, 1000, 100, 100, 100, 10, 10, & 
            !              10,  10, 10, 10, 10, 10, &
            !              10, 100, 100, 100, 10, 100, 10, 10]
            !     DAparVal(153:156) = temp_new_parval(153:156)
            !     DAparVal(158:160) = temp_new_parval(158:160)
            !     DAparVal(162:164) = temp_new_parval(162:164)
            !     DAparVal(168)     = temp_new_parval(168)
            !     DAparVal(224:227) = temp_new_parval(224:227)
            !     DAparVal(230)     = temp_new_parval(230)
            !     DAparVal(232:240) = temp_new_parval(232:240)
            ! elseif(iDAsimu < istep_3) then
                ! tree
                obsWt = [0, 10, 10, 10, 10, 10, 10, 10, & 
                         100,  100, 1000, 1000, 100, 10, &
            ...
            !     obsWt = [0, 10, 10, 10, 10, 10, 10, 10, & 
            !              10, 10, 10, 10, 10, 100, &
            !              1000, 100, 100, 100, 1000, 10, 1000, 1000]
            ...
            !     obsWt = [0, 10, 10, 10, 10, 10, 10, 10, & 
            !              10, 10, 10, 10, 10, 10, &
            !              100, 1000, 1000, 1000, 100, 10, 10, 10]
            !     ! er
            !     DAparVal(162:164) = temp_new_parval(162:164)
            !     DAparVal(176:240) = temp_new_parval(176:240)
            !     DAparVal(252:254) = temp_new_parval(252:254)
            ...
            ! else
            !     ! all parameters
            !     obsWt = [0, 100, 100, 10, 10, 10, 100, 100, & 
            !              100, 100, 10, 10, 10, 10, &
            !              100, 1000, 1000, 1000, 100, 10, 10, 10]
            ...
            if(iDAsimu == istep_1) search_scale = 0.03! mcset%search_scale
            if(iDAsimu == istep_2) search_scale = 0.03! mcset%search_scale
            if(iDAsimu == istep_3) search_scale = 0.03! mcset%search_scale
            if(iDAsimu == istep_4) search_scale = 0.03! mcset%search_scale
            if(iDAsimu == istep_5) search_scale = 0.03! mcset%search_scale
            if(iDAsimu == istep_6) search_scale = 0.03! mcset%search_scale
            if(iDAsimu == istep_7) search_scale = 0.03! mcset%search_scale
            if(iDAsimu == istep_8) search_scale = 0.03! mcset%search_scale
            if(iDAsimu == istep_9) search_scale = 0.03! mcset%search_scale
